			...
			<nav class="navbar navbar-custom">
				<div class="container">
					<div class="navbar-header">
						...
						<a class="navbar-brand page-scroll" href="#page-top">@funlovingcoder</a> 
					</div>
						...
						<ul class="timeline">
							...
							<li class="timeline-inverted">
								...
								<div class="timeline-panel">
									<div class="timeline-heading">
										<h4>Aryan College Ajmer</h4>
										<h4 class="subheading">Bachelor of Science (IT)</h4>
									</div>
								</div>
							</li>
						</ul>
			...
			<div class="container">
				...
				<div class="col-md-8 col-md-offset-2">
					...
					<div class="col-md-4">
						...
						<a href="mailto:lalit9799991992@gmail.com">lalit9799991992@gmail.com</a>
					</div>
					<div class="col-md-4">
				...
				<div class="col-md-8 col-md-offset-2">
					...
					<form action="https://www.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8" method="POST">
						...
						<input type=hidden name="oid" value="00D28000001pqam">
						<input type=hidden name="retURL" value="http://www.funlovingcoder.com">
						...
						<!--  value="lalit9799991992@gmail.com">                                      -->
						<!--  ----------------------------------------------------------------------  -->
						<div class="row">
						  <div class="col-md-6">
...
<!--<input type="text" id="name" class="form-control" placeholder="Name" required="required">-->
						  ...
						  <div class="col-md-6">
							...
							<input  id="name" maxlength="80" name="last_name" size="20" type="text" 
						...
						<div class="form-group">
						  <label for="email">Email</label>
						    <input  id="email" maxlength="80" name="email" size="20" type="text" class="form-control"  									placeholder="Email" required="required" />
<!--							<textarea name="message" id="message" class="form-control" rows="4" placeholder="Message" required></textarea>-->
						  <p class="help-block text-danger"></p>
						</div>
						<div class="form-group">
						  <label for="description">Description</label>
						<textarea name="description" id="message" class="form-control" rows="4" placeholder="Message" required></textarea><br>
					...
					<div class="social">
						<ul>
							<li><a href="https://www.facebook.com/funlovingcoder" target="_blank"><i class="fa fa-facebook"></i></a></li>
